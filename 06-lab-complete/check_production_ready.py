...
Auto-checks whether the project is ready for deployment.
...
def run_checks():
    ...
    results.append(check("No hardcoded secrets in code", len(secrets_found) == 0, str(secrets_found) if secrets_found else ""))
